...
import 'package:qr_inventory_system/inventory/daily_inventory.dart';
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          if (_scanBy != null) {
                            ...
                            DailyInventory _dailyInventory = DailyInventory();
                            _dailyInventory.insert(_newEntry);
                            Alert_dialog(
                              context: context,
                              title: "Success",
